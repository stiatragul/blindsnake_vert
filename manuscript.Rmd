...
Total number of vertebrae varies greatly among the Australo-Papuan blindsnakes in this study (Fig. \@ref(fig:fig-tree-boxplots)), ranging from 146 in *A. tovelli* to 400 in *A. grypus* (**Table S1**). Aspect ratios also vary greatly, ranging from 20.8 in the robust-and-wide *A. pinguis* to 169.8 in the narrow-and-long *A. longissimus* (**Table S2**). Intraspecific variation is also present in both aspect ratio and total number of vertebrae (Fig. \@ref(fig:fig-tree-boxplots)).
