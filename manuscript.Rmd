...
3. Do vertebral number and body size vary with mean annual temperature?
...
### Relationship between pleomerism and body shape
...
Temperature seem to have XXX effect. Common garden experiments for different species of snakes can tell us if incubation temperature and thus rate of development influences number of vertebrae. We would expect higher temperature to accelerate development (CITE anolis papers, turtles, etc), so less time for embryonic development. 
