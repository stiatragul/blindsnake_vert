...
For the Australian blindsnake genus *Anilios*, we found a weakly positive but non-statistically significant relationship between maximum number of total vertebrae and maximum TBL (PGLS, slope = 0.28, intercept = 256, R^2^ = 0.02, F = 0.74, Z = 0.30, P = 0.41), indicating an absence of pleomerism in Australian blindsnakes (Fig. \@ref(fig:fig-tbl-vert) and **Fig S1**). This suggests that maximum length is achieved by elongating each vertebra rather than by adding additional vertebrae. Many species have more vertebrae than expected for their size. For example, *A. grypus* "West" is an intermediate length (relative to other species) but has the greatest number of vertebrae, while *A. torresianus*, which has the greatest maximum TBL, has relatively few vertebrae. We found more phylogenetic signal than expected under Brownnian motion in both maximum number of total vertebrae (Z = 3.70, P = 0.001, K = 1.2; λ = 1.12, log likelihood(λ) = -197.20, LR(λ=0) = 11.82, P = 0.0006) and maximum TBL (Z = 3.02, P = 0.002, K = 1.0; λ = 1.14, log likelihood(λ) = -221.98, LR(λ=0) = 7.42, P = 0.006). 
